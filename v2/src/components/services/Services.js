...
import { Grid, Typography, Card, CardMedia, CardContent, Box, useMediaQuery, useTheme } from "@mui/material";
...
const ServicesSection = () => {
  ...
  return (
    <Box sx={{ textAlign: "center", py: 5, backgroundColor: "#fff", marginTop: 5 }}>
      <Typography variant={isSmallScreen ? "h5" : isMediumScreen ? "h4" : "h3"} sx={{ fontWeight: "bold", mb: 3 }}>
